...
/* harmony import */ var bootstrap_js_dist_alert__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! bootstrap/js/dist/alert */ "./node_modules/bootstrap/js/dist/alert.js");
/* harmony import */ var bootstrap_js_dist_alert__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(bootstrap_js_dist_alert__WEBPACK_IMPORTED_MODULE_5__);
...
function controllerMenu(idx) {
  if (idx === 1) {
    var moreIcon = document.getElementById('more-svg');
    var text = document.getElementById('more-text');
    var myCollapse = document.getElementById('collapseExample');
    var bsCollapse = new (bootstrap_js_dist_collapse__WEBPACK_IMPORTED_MODULE_2___default())(myCollapse, {
      toggle: false
    });
  ...
  if (idx === 2) {
    var _moreIcon = document.getElementById('as-more-svg');

    var _text = document.getElementById('as-more-text');
    ...
    myCollapse.addEventListener('show.bs.collapse', function () {
      _text.innerText = '顯示較少';

      _moreIcon.classList.add('transform-rotate-180');
    });
    myCollapse.addEventListener('hide.bs.collapse', function () {
      _text.innerText = '顯示較多';

      _moreIcon.classList.remove('transform-rotate-180');
    });
  }
} // 啟動
...
function renderCard() {
  ...
  for (var i = 0; i <= 23; i++) {
    resultStr += "\n        <div class=\"col mb-2 p-2\">\n            <div class=\"mt-0 mt-sm-1\">\n                <div id='card-p' class=\"card cursor-pointer position-relative\">\n                    <img id='img".concat(i, "' src=\"https://bruce-fe-ec.web.app/images/item.png\" class=\"card-img-top\" alt=\"...\">\n                    <span class=\"badge bg-primary position-absolute top-0 end-0 fw-normal\">\u96D911\u512A\u60E0</span>\n                    <div class=\"card-body p-2\">\n                        <p id='content").concat(i, "' class=\"card-text fs-7 text-wrap\">\u9739\u9742\u7121\u6575\u9AD8\u7D1A\u9999\u9999\u6C90\u6D74\u4E73</p>\n                        <h6 id='price").concat(i, "' class=\"card-title text-primary\">$199</h6>\n                        \n                        <p class=\"card-text d-flex justify-content-between align-items-center\">\n                            <small class=\"text-muted\">\u5DF2\u8CE3\u51FA99</small>\n                        \n                            <svg id='add-btn").concat(i, "' xmlns=\"http://www.w3.org/2000/svg\" width=\"30\" height=\"30\" fill=\"#FF5511\" class=\"add-btn bi bi-plus-circle-fill\" viewBox=\"0 0 16 16\">\n                                <path d=\"M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3z\"/>\n                            </svg>\n                        </p>\n                    </div>\n                </div>\n            </div>\n        </div>\n        ");
  }
...
function clickProduction() {
  var allProductionNums = document.querySelectorAll('.add-btn');
  var pdNum = allProductionNums.length;

  var _loop = function _loop(i) {
    allProductionNums[i].addEventListener('click', function () {
      document.getElementById("add-btn".concat(i));
    });
  };
...
clickProduction(); // 搜尋商品載入

function renderLoadingStyle() {
  var loading = document.getElementById('loading'); // loading
...
renderLoadingStyle(); // 計算商品數量

function calProduction() {
  var pd = document.getElementById('pd-nums');
  var num = document.getElementsByClassName('pd');
...
/******/ })()
;
//# sourceMappingURL=index80c2fcccf2987da8280e.js.map